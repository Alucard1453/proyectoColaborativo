...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2020 a las 19:53:05
...
CREATE TABLE `comentariosproyecto` (
  ...
  `idProyecto` int(11) NOT NULL,
  `fechaHora` varchar(22) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `proyecto` (
  ...
  `descripcion` varchar(512) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `fechaInicio` varchar(12) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `fechaFin` varchar(12) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
(3, 13, 'Proyecto 3', 'Descripción Proyecto 3', '10/06/2020', '17/06/2020', 8, 1),
(4, 13, 'Proyecto PruebaE', 'Descripción Proyecto E', '11/06/2020', '02/07/2020', 3, 1),
(5, 14, 'Elaboración Prueba', 'Descripción del proyecto de Esteban de prueba', '25/06/2020', '30/06/2020', 5, 1);
...
CREATE TABLE `rol` (
  ...
  `nombreRol` varchar(12) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
CREATE TABLE `tarea` (
  `idTarea` int(11) NOT NULL,
  `idProyecto` int(11) NOT NULL,
  `nombreTarea` varchar(30) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
(2, 1, 'Tarea 1', 1, 'Descripción Tarea 1', NULL, 1, 5),
(3, 1, 'Tarea 2', 2, 'Descripción Tarea 2', NULL, 1, 5),
(4, 1, 'Tarea 3', 3, 'Descripción Tarea 3', NULL, 1, 13),
(5, 1, 'Tarea 4', 4, 'Descripción Tarea 4', NULL, 1, 13),
(6, 1, 'Tarea 5', 5, 'Descipción Tarea 5', NULL, 1, 5),
(7, 1, 'Tarea 6', 6, 'Descripción Historia 6', NULL, 1, 5),
(8, 1, 'Tarea 7', 7, 'Descripción Historia 7', NULL, 1, 8),
(9, 1, 'Tarea 8', 8, 'Descripción Historia 8', NULL, 1, 8),
(10, 4, 'Tarea 1', 1, 'Descripción Historia 1', NULL, 1, 1),
(11, 4, 'Tarea 2', 2, 'Descripción Historia 2', NULL, 1, 2),
(12, 4, 'Tarea 3', 3, 'Descripción Historia 3', NULL, 1, 3),
(13, 4, 'Tarea 4', 4, 'Descripción Historia 4', NULL, 1, 5),
(14, 4, 'Tarea 5', 5, 'Descripción Historia 5', NULL, 1, 8),
(15, 4, 'Tarea 6', 6, 'Descripción Historia 6', NULL, 1, 13),
(16, 4, 'Tarea 7', 7, 'Descripción Historia 7', NULL, 1, 20),
(17, 4, 'Tarea 8', 8, 'Descripción Historia 8', NULL, 1, 2),
(18, 4, 'Tarea 9', 9, 'Descripción Historia 9', NULL, 1, 3),
(19, 4, 'Tarea 10', 10, 'Descripción Historia 10', NULL, 1, 3),
(20, 4, 'Tarea 11', 11, 'Descripción Historia 11', NULL, 1, 5),
(21, 4, 'Tarea 12', 12, 'Descripción Historia 12', NULL, 1, 5);
...
CREATE TABLE `usuario` (
  ...
  `aPaterno` varchar(25) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `aMaterno` varchar(25) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `usuario` varchar(15) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `contrasena` varchar(12) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
